    ...
    <div className="overflow-hidden">
      <section className="relative soft-grid">
        ...
        <div className="page-shell grid min-h-[calc(100vh-5rem)] items-center gap-14 py-20 lg:grid-cols-[0.92fr_1.08fr] lg:py-24">
          ...
          <motion.div initial={{ opacity: 0, y: 30, rotateX: 8 }} animate={{ opacity: 1, y: 0, rotateX: 0 }} transition={{ delay: 0.12, duration: 0.7, ease: [0.22, 1, 0.36, 1] }} className="relative perspective-1000">
            ...
            <div className="rounded-[1.75rem] border border-white/70 bg-white/80 p-3 shadow-[0_30px_110px_rgba(10,37,64,0.22)] backdrop-blur-2xl dark:border-white/10 dark:bg-slate-950/80">
